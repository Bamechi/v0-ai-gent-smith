      ...
      <div className="sticky top-0 h-screen overflow-hidden bg-[#060806]">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <Image src="/logo-mark-white.png" alt="" width={44} height={44} className="h-11 w-11 object-contain opacity-90" aria-hidden />
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-end">
              ...
              <div className="mono flex flex-wrap gap-x-10 gap-y-4 text-[#8fa58c]">
                <Stat value={1000} suffix="+" label="AI resources" />
                <Stat value={25} suffix="+" label="categories" />
                <Stat value={1} label="tool" />
              </div>
            </div>
...
function Stat({ value, label, suffix }: { value: number; label: string; suffix?: string }) {
  return (
    <div className="leading-none">
      <div className="font-display text-3xl text-[#f2f5f0] sm:text-4xl"><CountUp to={value} suffix={suffix} /></div>

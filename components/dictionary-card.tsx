...
export function DictionaryCard({ term, onClick }: DictionaryCardProps) {
  return (
    <Card
      className="group relative flex cursor-pointer flex-col overflow-hidden transition-all hover:scale-[1.02] rounded-xl border border-[#0f8a3e]/20 bg-gradient-to-br from-[#e8f5e9] via-[#c8e6c9] to-[#a5d6a7] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.4),0_4px_12px_-2px_rgba(0,66,8,0.15)] hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.5),0_8px_20px_-4px_rgba(0,66,8,0.25)] hover:border-[#0f8a3e]/40"
      onClick={onClick}
    >
      <CardHeader className="pb-3">
        <CardTitle className="text-xl font-black uppercase tracking-tight text-green drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)]">
      ...
      <CardContent className="flex flex-1 flex-col gap-3 mt-auto">
        <div className="flex flex-wrap gap-2">
          <Badge className="text-xs font-bold bg-green text-white hover:bg-green/90 border-none shadow-sm">
            {term.category}
          </Badge>
        </div>
      </CardContent>

...
export function SurveyResultsPage({ results }: SurveyResultsPageProps) {
  ...
  const levelStyles = {
    Starter: "bg-white border-2 border-[#0f8a3e] text-[#0f8a3e] shadow-[3px_3px_0_0_#0f8a3e]",
    Builder: "bg-[#0f8a3e] border-2 border-[#0f8a3e] text-white shadow-lg",
    "All-Star": "bg-gradient-to-r from-[#0f8a3e] to-[#0b6b2f] border-2 border-[#0f8a3e] text-white shadow-lg ring-2 ring-[#0f8a3e]/30 ring-offset-2",
  }

  const pathStyles = {
    "Content & Creative": "bg-[#0f8a3e]/10 border-2 border-dashed border-[#0f8a3e] text-[#0f8a3e]",
    "Business Ops & Automation": "bg-[#0f8a3e]/10 border-2 border-dashed border-[#0f8a3e] text-[#0f8a3e]",
    "Research & Decision Support": "bg-[#0f8a3e]/10 border-2 border-dashed border-[#0f8a3e] text-[#0f8a3e]",
    "Sales & Growth": "bg-[#0f8a3e]/10 border-2 border-dashed border-[#0f8a3e] text-[#0f8a3e]",
  }

  const profileStyles = "bg-[#0f8a3e] text-white border-2 border-[#0f8a3e] shadow-[inset_0_-2px_0_0_rgba(0,0,0,0.2)]"
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="text-center space-y-6">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-center">
            <span className="text-xs uppercase tracking-widest text-[#0f8a3e]/60 font-semibold">Codename</span>
            <span className="text-2xl md:text-3xl font-black text-[#0f8a3e] tracking-tight">{results.codename}</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        <Card className="border-2 border-[#0f8a3e]/30 bg-gradient-to-br from-white to-[#f0f9f0]">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-xl text-black">
              <Target className="w-5 h-5 text-[#0f8a3e]" />
            ...
            <ul className="space-y-3">
              {results.whereYouAre.map((item, i) => (
                <li key={i} className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-[#0f8a3e] flex-shrink-0 mt-0.5" />
        ...
        <Card className="border-2 border-[#0f8a3e]/30 bg-gradient-to-br from-white to-[#f0f9f0]">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-xl text-black">
              <Zap className="w-5 h-5 text-[#0f8a3e]" />
          ...
          <CardContent>
            <ul className="space-y-3">
              {results.whatToFocus.map((item, i) => (
                <li key={i} className="flex items-start gap-2">
                  <ArrowRight className="w-5 h-5 text-[#0f8a3e] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">{item}</span>
                </li>
              ))}
            </ul>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
          {results.recommendedTools.map((tool) => (
            <Link key={tool.name} href={tool.link}>
              <Card className="h-full cursor-pointer transition-all hover:scale-[1.02] border-2 border-[#0f8a3e]/20 hover:border-[#0f8a3e]/40 bg-gradient-to-br from-[#e8f5e9] via-[#c8e6c9] to-[#a5d6a7]">
                <CardHeader className="pb-2">
                  <CardTitle className="text-lg font-bold text-[#0f8a3e]">{tool.name}</CardTitle>
                </CardHeader>
                <CardContent>
        ...
        {results.recommendedTools.length < 3 && (
          <div className="text-center">
            <Link href={`/?category=${encodeURIComponent(results.path.split(" ")[0])}`}>
              <Button
                variant="outline"
                className="border-[#0f8a3e] text-[#0f8a3e] hover:bg-[#0f8a3e]/10 bg-transparent"
              >
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
          <Card className="border-2 border-[#0f8a3e]/20 bg-gradient-to-br from-[#e8f5e9] via-[#c8e6c9] to-[#a5d6a7]">
            <CardHeader>
              <Badge className="w-fit bg-[#0f8a3e] text-white mb-2">Featured</Badge>
              <CardTitle className="text-lg font-bold text-[#0f8a3e]">AVA AI</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <Button asChild className="w-full bg-[#0f8a3e] hover:bg-[#0f8a3e]/90 text-white">
          ...
          <Card className="border-2 border-[#0f8a3e]/20 bg-white">
            <CardHeader>
              <Badge className="w-fit bg-[#0f8a3e] text-white mb-2">Toolkit</Badge>
          ...
          <Card className="border-2 border-[#0f8a3e]/20 bg-white">
            <CardHeader>
              <Badge className="w-fit bg-[#0f8a3e] text-white mb-2">Bundle</Badge>
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <Card className="border-2 border-[#0f8a3e]/20 bg-white overflow-hidden hover:border-[#0f8a3e]/40 transition-all hover:shadow-lg">
            ...
            <CardHeader className="pb-2">
              <Badge className="w-fit bg-[#0f8a3e] text-white mb-2">Free eGuide</Badge>
          ...
          <Card className="border-2 border-[#0f8a3e]/20 bg-white overflow-hidden hover:border-[#0f8a3e]/40 transition-all hover:shadow-lg">
            ...
            <CardHeader className="pb-2">
              <Badge className="w-fit bg-[#0f8a3e] text-white mb-2">Free Dictionary</Badge>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Button asChild variant="outline" className="w-full border-[#0f8a3e] text-[#0f8a3e] hover:bg-[#0f8a3e]/10 bg-transparent">
          ...
          <Card className="border-2 border-[#0f8a3e]/20 bg-white overflow-hidden hover:border-[#0f8a3e]/40 transition-all hover:shadow-lg">
            ...
            <CardHeader className="pb-2">
              <Badge className="w-fit bg-[#0f8a3e] text-white mb-2">Free Suite</Badge>
      ...
      {/* Footer CTA */}
      <section className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8 border-t border-[#0f8a3e]/20">
        <Button asChild size="lg" className="bg-[#0f8a3e] hover:bg-[#0f8a3e]/90 text-white">
          <Link href="/">
